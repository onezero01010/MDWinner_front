...
class Piethon2():
    ...
    """Piethon2 crew"""
    def __init__(self,background_info,sc_data):
    ...
    def agent_ask(self) -> Agent:
        return Agent(
            ...
            goal=(
                ...
                f"환자의 배경 정보는 다음과 같습니다: {self.background_info}. "
                f"환자의 진료 정보는 다음과 같습니다: {self.sc_data}. "
    ...
    def agent_diagnosis(self) -> Agent:
        return Agent(
            ...
            환자의 배경 정보: {self.background_info}
            환자의 진료 정보: {self.sc_data}
